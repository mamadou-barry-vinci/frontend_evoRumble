...
const PRODUCTION_API_BASE_URL = 'evorumble-api.azurewebsites.net'; // to be changed to point to the URL of your API
...
const PRODUCTION_PATH_PREFIX = '/frontend_evoRumble/'; // e.g. '/mymovies/' if you deploy to GitHub Pages as a Project site : mymovies would be the repo name
